...
Config.Items = {
    ...
    -- Materiales configurados para futuras integraciones
    -- o sistemas externos de crafting/recoleccion.
    cable = 'radio_cable',
    metal = 'scrap_metal',
...
Config.Antenna = {
    ...
    construction = {
        ...
        -- Probabilidad de recuperar el kit de antena
        -- al retirar una antena propia.
        --
        -- 75 = 75% de probabilidad
        -- 100 = siempre devuelve el kit
        -- 0 = nunca devuelve el kit
        returnPercent = 75,
